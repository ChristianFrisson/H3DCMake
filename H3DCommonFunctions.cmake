...
function( findH3DProjectsIncludeDirsAndLibraries )
  set( options )
  set( oneValueArgs )
  set( multiValueArgs PROJECT_NAMES INCLUDE_DIRS_OUTPUT_VAR LIBRARIES_OUTPUT_VAR REQUIRED_PROJECTS )
  include( CMakeParseArguments )
  cmake_parse_arguments( find_h3d_projects_dirs_libs "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN} )
  if( handle_precompiled_headers_UNPARSED_ARGUMENTS )
    message( FATAL_ERROR "Unknown keywords given to findH3DProjectsIncludeDirsAndLibraries(): \"${find_h3d_projects_dirs_libs_UNPARSED_ARGUMENTS}\"" )
  endif()
  
  set( required_args PROJECT_NAMES )
  foreach( required_arg ${required_args} )
    if( NOT find_h3d_projects_dirs_libs_${required_arg} )
      message( FATAL_ERROR "The required argument ${required_arg} is missing when calling findH3DProjectsIncludeDirsAndLibraries." )
    endif()
  endforeach()
  ...
  if( find_h3d_projects_dirs_libs_LIBRARIES_OUTPUT_VAR )
    list( REMOVE_DUPLICATES tmp_libraries )
